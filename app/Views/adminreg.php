...
<body>
<section class="vh-110" style="background-color: #db7722;">
                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form action="/registerAcc" method="post">
                                    ...
                                    <div class="form-outline mb-2">
                                        <input type="text" id="username" name="username" class="form-control form-control-lg" value="<?=set_value('username')?>"/>
